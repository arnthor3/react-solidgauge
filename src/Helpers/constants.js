...
export const GROUP_ARC_CLASS = `${R}-arc`;

export const GROUP_ARC = `g.${GROUP_ARC_CLASS}`;

export const BACKGROUND_PATH = `${R}-background`;

export const VALUE_PATH = `${R}-value`;

export const MOUSE_PATH = `${R}-mouse`;

export const TEXT_LABEL = `${R}-label`;
